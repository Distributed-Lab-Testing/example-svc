...
GENERATED="${GOPATH}/src/github.com/Distributed-Lab-Testing/example-svc/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/Distributed-Lab-Testing/example-svc/docs/web_deploy"
