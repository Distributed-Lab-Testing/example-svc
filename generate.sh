...
GENERATED="${GOPATH}/home/user/Tasks/Distributed-Lab-Testing/example-svc/resources"
OPENAPI_DIR="${GOPATH}/home/user/Tasks/Distributed-Lab-Testing/example-svc/docs/web_deploy"
